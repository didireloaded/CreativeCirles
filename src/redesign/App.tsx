...
export default function App(){
 ...
 const [create,setCreate]=useState<'create'|'drafts'|null>(null); const [toast,setToast]=useState(''); const [navCompact,setNavCompact]=useState(false); const page=pathPage(location.pathname);
 ...
 const props:ScreenProps={notify:setToast,navigate,openCreate:()=>setCreate('create'),openDrafts:()=>setCreate('drafts'),profile,editPreferences};
 ...
 {create&&<CreateFlow initialDrafts={create==='drafts'} onClose={()=>setCreate(null)} notify={setToast}/>} {toast&&<div className="toast" role="status">{toast}</div>}</div>
}
